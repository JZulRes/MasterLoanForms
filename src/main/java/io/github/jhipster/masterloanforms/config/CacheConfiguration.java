package io.github.jhipster.masterloanforms.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MasterLoanForms");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MasterLoanForms");
        ...
        config.getMapConfigs().put("io.github.jhipster.masterloanforms.domain.*", initializeDomainMapConfig(jHipsterProperties));
