...
public class QuestionResourceIntTest {
     ...
     *
     * @see io.github.jhipster.masterloanforms.repository.search.QuestionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchQuestion() throws Exception {
        // Initialize the database
        questionService.save(question);
        when(mockQuestionSearchRepository.search(queryStringQuery("id:" + question.getId())))
