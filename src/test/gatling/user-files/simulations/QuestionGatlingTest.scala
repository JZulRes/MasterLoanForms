...
class QuestionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Question entity")
        ...
        .repeat(2) {
            ...
            .get("/masterloanforms/api/questions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new question")
            .post("/masterloanforms/api/questions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "textQuestion":"SAMPLE_TEXT"
                }""")).asJSON
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/masterloanforms${new_question_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created question")
            .delete("/masterloanforms${new_question_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
